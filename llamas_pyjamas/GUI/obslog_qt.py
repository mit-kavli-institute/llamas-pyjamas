...
class Ui_LLAMASObservingLog(object):
    def setupUi(self, LLAMASObservingLog):
        ...
        LLAMASObservingLog.resize(1099, 606)
        ...
        self.quicklookButton.setGeometry(QtCore.QRect(300, 250, 113, 32))
    ...
    def retranslateUi(self, LLAMASObservingLog):
        ...
        self.refreshButton.setText(_translate("LLAMASObservingLog", "Refresh List"))
        ...
        self.quicklookButton.setText(_translate("LLAMASObservingLog", "Quick Look"))
